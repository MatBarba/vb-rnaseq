use utf8;
package RNAseqDB::Schema::Result::VocabularyTrack;
...
Related object: L<RNAseqDB::Schema::Result::Vocabulary>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yWa81pl9agUZeYDtue4RUA
