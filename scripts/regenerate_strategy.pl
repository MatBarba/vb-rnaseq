...
my $ne = $db->regenerate_experiments_strategy();
$logger->info("$ne experiment strategy regenerated");
$db->regenerate_tracks_strategy();
$logger->info("track strategies regenerated from experiments");
...
sub usage {
  ...
  $help .= <<'EOF';
    Regenerate the strategy field of experiments and tracks.
